...
public class FindInquiryDetailsListActivity extends BaseActivity<Presenter> implements Contract.IView {
                ...
                if (i==0) {
                    imgSend.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            String trim = etContentDetails.getText().toString().trim();
                            ...
                            Message message = conversation.createSendMessage ( new TextContent( contentDetails ) );
                            ...
                            message.setOnSendCompleteCallback ( new BasicCallback() {
                                ...
                                public void gotResult(int i, String s) {
                                    if (i==0){
                                        ...
                                        presenter.doPushMessage(doctorId,sessionId,inquiryId,contentDetails, Constant.TYPE_TWO,userId1);
    ...
    public void onSuccessOne(Object one) {
        ...
        Logger.e(TAG,pushMessageBean.getMessage());
    }
